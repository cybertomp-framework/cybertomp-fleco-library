...
/**
 * Listener interface for receiving progress events generated by FLECO. Classes
 * interested in monitoring the evolution process must implement this interface
 * and register themselves in the corresponding FLECO instance.
 *
 * Implementations should be lightweight and non-blocking, as they may be
 * invoked frequently during the simulation.
 *
...
public interface IFLECOProgressEventListener extends EventListener {
    ...
    /**
     * Invoked when a progress event is generated by FLECO.
     *
     * @param progressEvent the event containing the current simulation status.
     */
